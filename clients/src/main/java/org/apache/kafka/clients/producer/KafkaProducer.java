...
import org.apache.kafka.clients.telemetry.ResourceLabelConfigs;
...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    KafkaProducer(ProducerConfig config,
        ...
        try {
            ...
            // null transactionalId will be filtered out, see ClientTelemetryUtils.ResourceLabels
            this.clientTelemetry = ClientTelemetryUtils.create(config, time, clientId, Collections.singletonMap(ResourceLabelConfigs.PRODUCER_TRANSACTIONAL_ID, transactionalId));
