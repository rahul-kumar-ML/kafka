...
public enum ClientTelemetryState {
    ...
    static {
        ...
        VALID_NEXT_STATES.put(
            PUSH_IN_PROGRESS, Arrays.asList(SUBSCRIPTION_NEEDED, TERMINATING_PUSH_NEEDED,
                TERMINATED));
        ...
        // terminated.
        VALID_NEXT_STATES.put(
            TERMINATING_PUSH_NEEDED, Arrays.asList(TERMINATED, TERMINATING_PUSH_IN_PROGRESS,
                TERMINATED));
