...
public abstract class AbstractFetch<K, V> implements Closeable {
    ...
    protected final FetchClientChecker fetchClientChecker;
    ...
    public AbstractFetch(final LogContext logContext,
                         ...
                         final FetchClientChecker fetchClientChecker,
                         final Time time) {
        ...
        this.fetchClientChecker = fetchClientChecker;
        this.time = time;
    ...
    protected Map<Node, FetchSessionHandler.FetchRequestData> prepareFetchRequests() {
        ...
        for (TopicPartition partition : fetchablePartitions()) {
            ...
            if (fetchClientChecker.isUnavailable(node)) {
                fetchClientChecker.maybeThrowAuthFailure(node);
    ...
    protected Map<Node, FetchSessionHandler.FetchRequestData> prepareCloseFetchSessionRequests() {
        ...
        sessionHandlers.forEach((fetchTargetNodeId, sessionHandler) -> {
            ...
            if (fetchTarget == null || fetchClientChecker.isUnavailable(fetchTarget)) {
